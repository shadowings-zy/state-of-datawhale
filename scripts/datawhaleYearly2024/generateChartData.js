const m1 = require("./data/2024/organizationDetail/2024-1.json");
const m5 = require("./data/2024/organizationDetail/2024-5.json");
const m9 = require("./data/2024/organizationDetail/2024-9.json");
const m12 = require("./data/2024/organizationDetail/2024-12.json");
const repoDetail = require("./data/2024/repo.json");
...
const generateRepoDetailData = () => {
  ...
  const repoDetailData = repoNameList.map((item) => {
    const jsonPath = path.join(__dirname, `./data/2024/repoDetail/${item}.json`);
...
export const generateStateOfDatawhale2024Data = () => {
